        ...
        <div className="section-inner">
          ...
          <div style={{ marginBottom: "3.5rem" }}>
            ...
            <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap" as const, gap: "1.5rem" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.6rem", padding: "0.6rem 1.2rem", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "100px", flexShrink: 0 }}>
                ...
                <span style={{ fontFamily: "var(--font-body)", fontSize: "0.72rem", fontWeight: 500, letterSpacing: "0.1em", textTransform: "uppercase" as const, color: "var(--text-secondary)" }}>
                  Seg – Sex
                </span>
              </div>
            </div>
          ...
          >
            {TURNOS.map(({ titulo, range, horarios, icon }, idx) => (
              <>
                {idx > 0 && <div key={`div-${idx}`} className="hor-divider" />}

                <div
                  key={titulo}
                  className="hor-turno-col"
                  style={{ flex: 1, padding: "2.5rem", display: "flex", flexDirection: "column" as const, gap: "1.75rem" }}
                >
                  {/* Cabeçalho do turno */}
                  <div>
                    <div style={{ display: "flex", alignItems: "center", gap: "0.6rem", marginBottom: "0.4rem", color: "var(--gray-light)" }}>
                      {icon}
                      <span style={{ fontFamily: "var(--font-body)", fontSize: "0.68rem", fontWeight: 600, letterSpacing: "0.2em", textTransform: "uppercase" as const }}>
                        {titulo}
                      </span>
                    </div>
                    <p style={{ fontFamily: "var(--font-title)", fontWeight: 900, fontSize: "1.75rem", letterSpacing: "-0.02em", color: "var(--white)", lineHeight: 1 }}>
                      {range}
                    </p>
                  </div>
                  ...
                  <div style={{ display: "flex", flexWrap: "wrap" as const, gap: "0.5rem" }}>
                    {horarios.map(h => (
                      <span key={h} className="hor-chip">{h}</span>
                    ))}
                  </div>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap" as const, gap: "1.5rem" }}>
            <p style={{ fontSize: "0.8rem", fontWeight: 300, color: "var(--text-muted)", fontFamily: "var(--font-body)", lineHeight: 1.7 }}>
              Turmas com no máximo 4 alunos por sessão.
              <br />
              Vagas limitadas — garante o seu horário.
            </p>
