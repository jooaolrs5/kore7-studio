          ...
          >
            ...
            <div>
              ...
              >
                ...
                >
                  Nosso Studio nasceu com um propósito claro: entregar{" "}
                  <strong>resultado real, atendimento próximo</strong> e uma
                ...
                >
                  Trabalhamos com horários agendados, turmas reduzidas,
                  acompanhamento profissional e{" "}
                  <strong>metodologia própria de treinamento integrado</strong>,
                  combinando condicionamento, mobilidade e prevenção de lesões.
                </p>
                ...
                >
                  Somos um espaço de treinamento personalizado, pensado para
                  quem quer fugir de academia lotada e busca{" "}
                  <strong>
                    acompanhamento próximo, personalizado, estratégico e de alta
                    qualidade
                  </strong>
                  .
                </p>
                ...
                >
                  Caso exista qualquer necessidade específica, lesão ou
                  limitação, todo o processo será conduzido com segurança e
                  acompanhamento especializado. Nosso compromisso é cuidar de
                  cada detalhe para que você evolua de forma consistente e
                  sustentável —{" "}
                  <strong>
                    seja emagrecimento, hipertrofia, performance ou saúde
                  </strong>
                  .
                </p>
              </div>
